...
class UIEditBill : UIView, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    private let lblTitle = newLabel(fontSize: 25, fontWeight: .bold, textColor: .black, defaultText: "Edit your Bill")
    ...
    private func initialize() {
        ...
        self.addSubviews(pickerBill, lblTitle, txtDescription, txtAmount, datePicker, btnConfirm, imageClose)
    }
...
//            pickerBill.widthAnchor.constraint(equalTo: self.safeAreaLayoutGuide.widthAnchor, multiplier: 0.6),
            ...
            btnConfirm.topAnchor.constraint(equalTo: datePicker.bottomAnchor, constant: 30),
